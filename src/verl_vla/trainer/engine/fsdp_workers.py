...
class RobActorRolloutRefWorker(ActorRolloutRefWorker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if self.config.get("algorithm", "grpo") == "sac":
            from verl_vla.workers.rollout.naive_rollout_pi05 import PI0RolloutRob
    ...
    def init_model(self):
        ...
        if self._is_actor:
            ...
            if self.config.get("algorithm") == "sac":
                from verl_vla.workers.actor_critic.sac_actor import RobDataParallelSACActor
                ...
                from verl_vla.trainer.ppo.dp_rob import RobDataParallelPPOActor
