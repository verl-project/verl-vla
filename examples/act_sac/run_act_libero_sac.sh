...
"$PYTHON" -m verl_vla.entrypoints.train.sac \
    ...
    cluster.actor_rollout_ref.model.override_config.n_action_steps=$ACTION_CHUNK_STEPS \
    cluster.actor_rollout_ref.model.override_config.critic_type=mean_pool \
