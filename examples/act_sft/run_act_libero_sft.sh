...
$PYTHON -m verl_vla.entrypoints.train.sft \
    ...
    cluster.actor_rollout_ref.model.override_config.n_action_steps=$ACT_ACTION_STEPS \
    cluster.actor_rollout_ref.model.override_config.freeze_vision_tower=$FREEZE_VISION_TOWER \
    cluster.actor_rollout_ref.model.override_config.optimizer_lr_backbone=$BACKBONE_LR \
